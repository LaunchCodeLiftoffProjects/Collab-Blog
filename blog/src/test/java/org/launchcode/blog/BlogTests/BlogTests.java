...
public class BlogTests {
	...
	public void fillDatabaseWithBlogs() {
		...
		Blog blog1 = new Blog("New Header", "New Subheader", "New Author", "New Image", "New Body");
		Blog blog2 = new Blog("Second Header", "New Second Header", "New Second Author", "Second image", "Second Body");
	...
	public void postBlogs_SavesBlogToDatabase() throws Exception {
		blogTestsUtil.tearDown();
		Blog blog1 = new Blog("Our Very First Blog Post", "This is an actual Subheader", "I am the Author", "An Actual Image", "This body has things we actually care about");
	...
	public void getBlogById_ReturnsCorrectBlog() throws Exception {
		blogTestsUtil.tearDown();
		Blog blog1 = new Blog("Superman", "Batman", "Wonder Woman", "Image of Justice League", "They are the superior super heroes");
		blogRepository.save(blog1);
